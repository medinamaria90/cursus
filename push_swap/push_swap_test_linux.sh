...
printf ${BLUE}"\n-------------------------------------------------------------\n"${DEF_COLOR};
printf ${BLUE}"\n\t\t\t NEXT BASIC IMPUT Basic input\t\t\n"${DEF_COLOR};
printf ${BLUE}"\n-------------------------------------------------------------\n\n"${DEF_COLOR};

ARG="2 1";
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 4 ]; then
	printf "${GREEN}1.FIRTS[OK] ${DEF_COLOR}";
else
	printf "${RED}1.[KO]${DEF_COLOR}";
	printf "${WHITE} TEST: ";
	echo -n "$ARG "
...
if [ "$S" == "OK" ]; then
	printf "${GREEN}2SECOND.[OK] ${DEF_COLOR}";
else
	printf "${RED}2.[KO]${DEF_COLOR}";
fi
...
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 13 ]; then
	printf "${GREEN}3THIRD.[OK] ${DEF_COLOR}";
else
	printf "${RED}3.[KO]${DEF_COLOR}";
	printf "${WHITE} TEST: ";
	echo -n "$ARG "
...
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 4 ]; then
	printf "${GREEN}1 ELEVEN.[OK] ${DEF_COLOR}";
else
	printf "${RED}11.[KO]${DEF_COLOR}";
	printf "${WHITE} TEST: ";
	echo -n "$ARG "
...
if [ "$S" == "OK" ]; then
	...
	printf "${RED}30. ERROR [KO]${DEF_COLOR}";
fi
...
R=$(./push_swap $ARG | ./checker $ARG)
if [ "$S" == $R ]; then
	printf "${GREEN}6 6 6.[OK] ${DEF_COLOR}\n";
else
	printf "${RED}6.[KO]${DEF_COLOR}\n";
fi
...
R=$(./push_swap $ARG | ./checker $ARG)
if [ "$S" == $R ]; then
	printf "${GREEN}7 7 7.[OK] ${DEF_COLOR}\n";
else
	printf "${RED}7.[KO]${DEF_COLOR}\n";
fi
...
R=$(./push_swap $ARG | ./checker $ARG)
if [ "$S" == $R ]; then
	printf "${GREEN}8 8 8.[OK] ${DEF_COLOR}\n";
else
	printf "${RED}8.[KO]${DEF_COLOR}\n";
fi
...
R=$(./push_swap $ARG | ./checker $ARG)
if [ "$S" == $R ]; then
	printf "${GREEN}9 9 9.[OK] ${DEF_COLOR}\n";
else
	printf "${RED}9.[KO]${DEF_COLOR}\n";
fi
...
R=$(./push_swap $ARG | ./checker $ARG)
if [ "$S" == $R ]; then
	printf "${GREEN}10. THE LAST [OK] ${DEF_COLOR}\n";
else
	printf "${RED}10.[KO]${DEF_COLOR}\n";
fi
